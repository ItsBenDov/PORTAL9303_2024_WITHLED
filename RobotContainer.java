...
public class RobotContainer {
  ...
  private final Trigger rightClimberDownButton = new JoystickButton(joystick,3);
  private final Trigger rightClimberUpButton = new JoystickButton(joystick,2);
  private final Trigger leftClimberDownButton = new JoystickButton(joystick,11);
  private final Trigger leftClimberUpButton = new JoystickButton(joystick,12);
...
// private final LimeLight vision;
  ...
  private void configureBindings() {
    ...
    rightClimberDownButton.onTrue(new InstantCommand(() -> climber.setMotorRight(-0.5)));
    rightClimberDownButton.onFalse(new InstantCommand(() -> climber.setMotorRight(0)));
    rightClimberUpButton.onTrue(new InstantCommand(() -> climber.setMotorRight(0.5)));
    rightClimberUpButton.onFalse(new InstantCommand(() -> climber.setMotorRight(0)));

    leftClimberDownButton.onTrue(new InstantCommand(() -> climber.setMotorLeft(-0.5)));
    leftClimberDownButton.onFalse(new InstantCommand(() -> climber.setMotorLeft(0)));
    leftClimberUpButton.onTrue(new InstantCommand(() -> climber.setMotorLeft(0.5)));
    leftClimberUpButton.onFalse(new InstantCommand(() -> climber.setMotorLeft(0)));
